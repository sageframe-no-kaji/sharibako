...
*Remaining prompts, filled at close:*

- **Did the flat-grounds bet hold at the gate,** or did the sidebar fallback
  fire? What did flat-vs-vibrant actually read like in dark?
- **Does the panel earn its width** — is the emptied toolbar an improvement in
  use, not just in principle?
- **Decision review.** Idiom, appearance home, grounds, rust — which held?
- **What broke that the tests didn't catch?** (View-layer, by design — that is
  what the gate is for.)
- **Followups** — for ho-06.3 / ho-06.6 / the K4 overview pass. In particular:
  does the panel change where 06.6's scan-root management wants to live?
...
forward-only response to ho-06.2's gate finding). Execution and Reflect:
pending._
